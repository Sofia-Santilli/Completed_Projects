...
int getVrepProcAddresses(LIBRARY lib)
{
    ...
    if (simReadCustomDataBlockTags==0)
    {
    ...
    if (simGetScaledImage==0)
    {
        printf("%s simGetScaledImage\n",couldNotFind);
        return 0;
    }
    if (simTransformImage==0)
    {
    ...
    if (simPushUInt8TableOntoStack==0)
    {
    ...
    if (simIntersectPointsWithPointCloud==0)
    {
    ...
    if (simSubtractObjectFromPointCloud==0)
    {
    ...
    if (simSetVisionSensorFilter==0)
    {
        printf("%s simSetVisionSensorFilter\n",couldNotFind);
        return 0;
    }
    if (simGetVisionSensorFilter==0)
    {
        printf("%s simGetVisionSensorFilter\n",couldNotFind);
        return 0;
    }
    if (simSetReferencedHandles==0)
    {
        printf("%s simSetReferencedHandles\n",couldNotFind);
        return 0;
    }
    if (simGetReferencedHandles==0)
    {
